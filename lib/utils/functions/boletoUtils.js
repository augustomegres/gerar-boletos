...
var Datas = (function () {
	...
	Datas.prototype.comDocumento = function (_documento) {
		_documento = new Date(moment(_documento, 'YYYY-MM-DD').format('YYYY-MM-DD'));
	...
	Datas.prototype.comProcessamento = function (_processamento) {
		_processamento = new Date(moment(_processamento, 'YYYY-MM-DD').format('YYYY-MM-DD'));
	...
	Datas.prototype.comVencimento = function (_vencimento) {
		_vencimento = new Date(moment(_vencimento, 'YYYY-MM-DD').format('YYYY-MM-DD'));
